...
const IconSparkle = (p) => (
  <Icon {...p}>
    ...
    <path d="M19 15l.7 1.9L22 17.5l-2.3.6L19 20l-.7-1.9L16 17.5l2.3-.6z" />
  </Icon>
);
...
const IconRuler = (p) => (
  <Icon {...p}>
    ...
    <path d="M9 8l2 2M12 5l2 2M6 11l2 2" />
  </Icon>
);
const IconWeight = (p) => (
  <Icon {...p}>
    <circle cx="12" cy="5" r="2.5" />
    <path d="M8 8h8l2.5 11a1 1 0 0 1-1 1.2H6.5a1 1 0 0 1-1-1.2z" />
  </Icon>
);
const IconLayers = (p) => (
  <Icon {...p}>
